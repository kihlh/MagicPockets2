...
exports.getProcessList = exports.KillProcess = exports.confirm = exports.Sleep = exports.HMC = void 0;
...
exports.HMC = new ffi_cross_1.default.Library(path_1.default.join(process.resourcesPath, "bin", "Dll1.dll"), {
    'confirm': [
        int, [charPtr, charPtr]
    ],
    "KillProcess": [
...
function confirm(tile, message) {
    ...
    if (typeof tile == 'string')
        tile = win32Text(tile);
    return !!exports.HMC.confirm(tile, message);
}
