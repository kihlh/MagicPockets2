...
export function readFilePaths(Index:number): string|null
export function readFilePaths(Index:unknown): unknown
 ...
 * 判断剪贴板中是否是文件路径
 */
export function hasPath():boolean
...
type writeText=Clipboard['writeText'];
...
export declare var availableFormats:availableFormats
export declare var writeText:writeText
export declare var writeImage:writeImage
export declare var writeRTF:writeRTF
export declare var writeHTML:writeHTML
export declare var writeFindText:writeFindText
export declare var writeBuffer:writeBuffer
export declare var readText:readText
export declare var readHTML:readHTML
export declare var write:write
export declare var readImage:readImage
export declare var readBookmark:readBookmark
export declare var readFindText:readFindText
export declare var readRTF:readRTF
