...
exports.getSystemErrorCodes = exports.system_error_codes_Link_obj = exports.system_error_codes = void 0;
...
exports.system_error_codes_Link_obj = {};
for (let system_error_contain of exports.system_error_codes) {
    const { code } = system_error_contain;
    exports.system_error_codes_Link_obj[code] = system_error_contain;
}
function getSystemErrorCodes(Code) {
    return exports.system_error_codes_Link_obj[Code];
}
exports.getSystemErrorCodes = getSystemErrorCodes;
//# sourceMappingURL=system-error-codes.js.map