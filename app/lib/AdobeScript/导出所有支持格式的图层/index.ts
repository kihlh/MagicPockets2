...
let ColorList = ["黑色", "深棕", "灰色", "白色", "深蓝", "浅灰", "藕粉", "薄荷色", "抹茶绿", "木炭灰", "驼色", "杏色", "棕色", "黄色", "浅蓝色", "绿色", "克莱因蓝"];
...
let is_Drew = app.activeDocument.name.match(/!--单面_DrewT恤带阴影800|!--单面_T恤带阴影800/);
let is_Drew_1200 =app.activeDocument.name.match(/!--单面_DrewT恤带阴影1200|!--单面_T恤带阴影1200/);

let is_Prints = is_Drew||is_Drew_1200 || confirm("Print？");
let is_ToPNG = is_Drew ||is_Drew_1200|| confirm("ToPNG?");
let ___Dir = "~/Pictures/Saved Pictures/kiic";
