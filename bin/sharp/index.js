...
const cssKeywords = __nccwpck_require__(71);
...
const conversions = __nccwpck_require__(456);
const route = __nccwpck_require__(314);
...
/* MIT license */
var colorNames = __nccwpck_require__(71);
var swizzle = __nccwpck_require__(575);
...
const colorString = __nccwpck_require__(658);
const convert = __nccwpck_require__(851);
...
const debug = __nccwpck_require__(123)
const { MAX_LENGTH, MAX_SAFE_INTEGER } = __nccwpck_require__(221)
const { re, t } = __nccwpck_require__(750)

const parseOptions = __nccwpck_require__(185)
const { compareIdentifiers } = __nccwpck_require__(350)
class SemVer {
...
const SemVer = __nccwpck_require__(24)
const parse = __nccwpck_require__(762)
const { re, t } = __nccwpck_require__(750)
...
const compare = __nccwpck_require__(376)
...
const { MAX_LENGTH } = __nccwpck_require__(221)
const { re, t } = __nccwpck_require__(750)
const SemVer = __nccwpck_require__(24)
...
const { MAX_SAFE_COMPONENT_LENGTH } = __nccwpck_require__(221)
const debug = __nccwpck_require__(123)
...
const is = __nccwpck_require__(157);
...
const color = __nccwpck_require__(237);
const is = __nccwpck_require__(157);
...
(__nccwpck_require__(657).hasVendoredLibvips)();
__nccwpck_require__(805);
...
const Sharp = __nccwpck_require__(239);
__nccwpck_require__(463)(Sharp);
__nccwpck_require__(741)(Sharp);
__nccwpck_require__(65)(Sharp);
__nccwpck_require__(477)(Sharp);
__nccwpck_require__(505)(Sharp);
__nccwpck_require__(341)(Sharp);
__nccwpck_require__(708)(Sharp);
__nccwpck_require__(133)(Sharp);
...
const color = __nccwpck_require__(237);
const is = __nccwpck_require__(157);
const sharp = __nccwpck_require__(805);
...
const semverCoerce = __nccwpck_require__(577);
const semverGreaterThanOrEqualTo = __nccwpck_require__(999);

const platform = __nccwpck_require__(450);
...
const detectLibc = __nccwpck_require__(975);
...
function __ncc_wildcard$0 (arg) {
  if (arg === "win32-x64") return __nccwpck_require__(389);
}
'use strict';

const platformAndArch = __nccwpck_require__(450)();
...
const { isLinux, getReport } = __nccwpck_require__(241);
...
var isArrayish = __nccwpck_require__(547);
...
module.exports = require(__nccwpck_require__.ab + "build/Release/sharp-win32-x64.node")
